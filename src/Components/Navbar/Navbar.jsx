  ...
  return (
    <div>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          ...
          <div className="flex flex-row items-center cursor-pointer">
            ...
            <p className="font-inter text-base font-medium tracking-normal leading-none text-center ml-0.5">
              Wish List
            </p>
          </div>
          <div
      ...
      <div className="bg-blue-gray-700 p-4 w-full flex justify-around">
        <div className="text-white font-inter text-base font-medium tracking-normal leading-none text-center ml-0.5">
          50% OFF
        </div>
        <div className="text-white font-inter text-base font-medium tracking-normal leading-none text-center ml-0.5">
